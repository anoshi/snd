...
class GameModeInvasion : GameMode {
	...
	protected SNDUserSettings@ m_userSettings;
	protected ResourceLifecycleHandler@ m_resourceLifecycleHandler;

	// --------------------------------------------
	GameModeInvasion(SNDUserSettings@ settings) {
	...
	protected void setupMapRotator() {
		@m_mapRotator = SNDMapRotator(this);
		SNDStageConfigurator configurator(this, m_mapRotator);
	}
	...
	// --------------------------------------------
	const SNDUserSettings@ getUserSettings() const {
		return m_userSettings;
	}

	// --------------------------------------------
	// SNDMapRotator calls here when a battle is about to start
	void preBeginMatch() {
		_log("** SND: preBeginMatch", 1);
	...
	// --------------------------------------------
	// SNDMapRotator calls here when a battle has started
	void postBeginMatch() {
		_log("** SND: postBeginMatch", 1);
	...
	*/
	...
	void save() {
		...
		_log("** SND: GameModeInvasion::saving metagame", 1);
