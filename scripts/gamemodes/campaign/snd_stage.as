...
// --------------------------------------------
class SNDStage : Stage {
	bool m_clearProfiles;

	// --------------------------------------------
	SNDStage(const UserSettings@ userSettings) {
		super(userSettings);
	...
	protected void appendResources(XmlElement@ mapConfig) const {
		...
		// const SNDUserSettings@ sndSettings = cast<const SNDUserSettings>(m_userSettings);
		// if (sndSettings !is null) {
		// 	if (sndSettings.m_difficulty == 0) {
		// 		{ XmlElement e("weapon");		e.setStringAttribute("file", "diff_0_rec_weapons.xml"); mapConfig.appendChild(e); }
		// 	} else if (sndSettings.m_difficulty == 1) {
		// 		{ XmlElement e("weapon");		e.setStringAttribute("file", "diff_1_pro_weapons.xml"); mapConfig.appendChild(e); }
		// 	} else if (sndSettings.m_difficulty == 2) {
